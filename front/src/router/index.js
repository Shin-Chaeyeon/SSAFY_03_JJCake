          ...
          children: [
            {
              ...
              path: 'customer',
              component: () =>
                import('../components/auth/signup/Signup_buy.vue'),
              default: true,
            },
            {
              name: 'seller',
              path: 'seller',
              component: () =>
                import('../components/auth/signup/Signup_sell.vue'),
            },
            {
              path: '',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          name: 'makeorder',
          path: 'makeorder',
          component: () => import('../components/order/makeorder.vue'),
          default: true,
        },
        {
          name: 'detailorder',
        ...
        },
        {
          ...
          component: () => import('../components/portfolio/create-portfolio.vue'),
          default: true,
        },
        {
          name: 'read-portfolio',
          path: 'read-portfolio',
          component: () => import('../components/portfolio/components/read-portfolio.vue'),
          default: true,
        },
        {
          name: 'mypage_sell',
          path: 'mypage_sell',
          component: () => import('../components/mypage/mypage_sell.vue'),
          default: true,
          props: true,
        },
        {
          name: 'mypage_buy',
          path: 'mypage_buy',
          component: () => import('../components/mypage/mypage_buy.vue'),
          default: true,
          props: true,
        },
        {
          name: 'ordercontrol',
          path: 'ordercontrol',
          component: () => import('../components/ordercontrol/ordercontrol.vue'),
          default: true,
          props: true,
        },
        {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              meta: {
                wikiLink:
                  'https://github.com/epicmaxco/vuestic-admin/wiki/Rating',
              },
            },
            {
              name: 'color-pickers',
            ...
            },
            {
              ...
              meta: {
                wikiLink:
                  'https://github.com/epicmaxco/vuestic-admin/wiki/Notifications',
              },
            },
            {
              path: 'icons',
              ...
              children: [
                {
                  ...
                  meta: {
                    wikiLink:
                      'https://github.com/epicmaxco/vuestic-admin/wiki/Icons',
                  },
                },
                {
                  name: 'icon-set',
            ...
            },
            {
              ...
              meta: {
                wikiLink:
                  'https://github.com/epicmaxco/vuestic-admin/wiki/Chips',
              },
            },
            {
              name: 'tree-view',
            ...
            },
            {
              ...
              meta: {
                wikiLink:
                  'https://github.com/epicmaxco/vuestic-admin/wiki/Collapse',
              },
            ...
            },
            {
              ...
              meta: {
                wikiLink:
                  'https://github.com/epicmaxco/vuestic-admin/wiki/Sliders',
              },
            },
            {
              name: 'popovers',
            ...
            },
            {
              ...
              meta: {
                wikiLink:
                  'https://github.com/epicmaxco/vuestic-admin/wiki/Lists',
              },
            },
          ],
        },
