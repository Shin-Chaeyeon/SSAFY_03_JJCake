<template>
  <div>
    <div class="createportfolio block">
      <p class="display-2 d-flex justify--center">리뷰 작성</p>
      <br />
      <hr />
      <br />
    </div>
    ...
    <span slot="footer" class="dialog-footer flex-center">
      <el-button type="warning" @click="writeReview">작성</el-button>
...
export default {
  ...
  methods: {
    ...
    writeReview() {
      ...
      form.append("buyerId", this.$store.getters.auth.id);
